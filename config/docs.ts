...
export const docsConfig: DocsConfig = {
  mainNav: [
    ...
    { title:"Telehealth Visit", href:"/category?mode=Telehealth%20Visit"},
    { title:"In-person Visit", href:"/category?mode=In-person%20doctor%20Visit"},
    { title:"Be healthcare provider", href:"/join/doctors"},
  ],
  sidebarNav: [
    {
