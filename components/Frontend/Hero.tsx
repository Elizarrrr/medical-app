...
const Hero = () => {
  const TEXTS = ['Dental','Paediatric','Therapist'];
  return (
      <div className="bg-sky-800 dark:bg-slate-950">
              ...
              <div className="w-full px-4 lg:w-6/12">
                <div className="hero-content">
                  <h1 className="mb-5 text-4xl font-bold !leading-[1.208] text-gray-50 dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl flex flex-wrap items-center gap-3">
                    <span>Book your</span> <TransitionalText TEXTS={TEXTS} className=""/> <br/> <span>sessions now</span>
                  </h1>
                  <p className="mb-8 max-w-[480px] text-base text-gray-100 dark:text-gray-50-6">
                    Dedicated to putting your well-being first, every step of the way, with trust and transparency.
                  </p>
                  {/* SEARCH BAR HERE */}
                  <SearchBar/>
                  {/* CTA BTNS */}
                  <ul className="flex flex-wrap items-center mt-6">
                    <li>
                      <a
                        href="/#"
                        className="inline-flex items-center justify-center rounded-md bg-white px-6 py-3 text-center text-base font-medium text-sky-800 hover:bg-sky-700 hover:text-white lg:px-7"
                      >
                        Need a Doctor
                      </a>
                    </li>
